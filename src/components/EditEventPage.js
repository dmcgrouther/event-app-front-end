                    ...
                    <div className="edit-event-input-area">
                        ...
                        <form onSubmit={this.handleSubmit}>
                            ...
                            <div className="edit-event-field">
                                ...
                                <textarea onChange={this.handleChange} className="form-control form-control-lg event-description-edit" type="text" required={true} name="eventDescription" value={this.state.eventDescription} />
                            </div>
